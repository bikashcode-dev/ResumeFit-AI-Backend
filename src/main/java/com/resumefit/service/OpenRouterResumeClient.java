...
@Component
public class OpenRouterResumeClient {
    ...
    public OpenRouterResumeClient(
            ObjectMapper objectMapper,
            @Value("${ai.openrouter.api-key:}") String apiKey,
            @Value("${ai.openrouter.model:openai/gpt-4o-mini}") String model,
            @Value("${ai.openrouter.url:https://openrouter.ai/api/v1/chat/completions}") String apiUrl
    ) {
